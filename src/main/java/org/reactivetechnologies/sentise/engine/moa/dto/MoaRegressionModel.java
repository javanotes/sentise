package org.reactivetechnologies.sentise.engine.moa.dto;
...
public class MoaRegressionModel extends RegressionModel {
	/**
	* 
	*/
	...
	public MoaRegressionModel() {
	}

	public MoaRegressionModel(Classifier trainedClassifier) {
		super();
	 ...
	 * @throws IOException
	 */
	public MoaRegressionModel(String trainedClassifier) throws IOException {
		super();
